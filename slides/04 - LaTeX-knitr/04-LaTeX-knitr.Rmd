...
output: 
  beamer_presentation: 
    ...
    highlight: haddock
header-includes:
    - \AtBeginDocument{\title[\LaTeX ]{04-\LaTeX-`knitr`}}
    - \AtBeginDocument{\author[Ottavia M. Epifania]{Ottavia M. Epifania \\ Università di Padova}}
    - \AtBeginDocument{\institute[]{ottavia.epifania@unipd.it}}
    - \usepackage{graphicx} 
    - \usepackage{setspace}
    - \usepackage{tabularx}
...
`In figura \ref{fig:doppia} [..]. In Figura \ref{sub:unipd1} [...] in Figura \ref{sub:grafico} [..]`
