...
````
![Caption della figura](percorso-alla-figura.png){width="40%", fig-align="center", #fig-label}
...
![PsicoStat](img/psicostat.png){#fig-psicostat}{fig-align="center"}
...
- Inserite un'immagine allineata a destra: 
