...
Se non dovesse funzionare, reinstallate il pacchetto `xfun` (`install.packages("xfun")`)


## Se anche così non dovesse funzionare....

<br> 

- Nella cartella dove avete il File-check.Rmd si dovrebbe essere creato un file con estensione `.tex`

- Aprite il file `.tex` con MikTek e provate a premere il play verde in alto 

- Probabilmente non compilerà il file, ma vi proporrà di installare una serie di pacchetti, lasciatelo fare!

- Riprovate a compilare il File-check.Rmd
...
[Qui](https://forms.gle/VS4RaevZ6XghDCjM9) trovate il questionario da compilare a fine corso per dire se il corso vi è piaciuto
