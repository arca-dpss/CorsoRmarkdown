...
- `beamer_presentation`: <font size="3">per ottenere `pdf`. Le vedremo nella lezione [04-LaTeX-knitr](https://ottaviae.github.io/CorsoRmarkdown/slides/03bis%20-%20LaTeX%20Bis/03bis-LaTeX-bis.pdf)</font>

- `xaringam`: <font size="3">sempre in html, ma mooooolto più carine [05-xaringam](https://ottaviae.github.io/CorsoRmarkdown/slides/03bis%20-%20LaTeX%20Bis/03bis-LaTeX-bis.pdf)</font>
