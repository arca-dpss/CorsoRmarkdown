...
L'environment di `R` e l'environment di `RMarkdown` sono due cose dievrse
...
- Va definito l'output `asis`
        ...
        `r knitr::asis_output(ifelse(knitr::is_html_output(), '\\@ref(tab:dist-types-tab-interactive)', '\\@ref(tab:dist-types-tab-static)'))` 
