...
Se viene messo ` highlightSpans: true` permette di evidenziare solo delle parti specifiche di codice invece che la roga intera. 

Basta mettere il codice che si vuole evidenziare dentro i backtick ```:
...
Invece che dividere il testo con tre `---` se ne mettono due `--` prima del testo (contenuto) che si vuole mostrare in modo incrementale: 
