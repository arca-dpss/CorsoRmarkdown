...
[Qui](https://docs.google.com/document/d/1xBr-zNRTvUrKABrU7CQDM_8rZVg2gmij_aaP-0laljM/edit) invece trovate i data set su cui lavoreremo durante il corso. Nel caso vogliate lavorare sul vostro dataset, dovete essere autonomi nelle analisi.


# Piccolo questionario

Ho preparato un piccolo [questionario](https://forms.gle/DLsnVT5JSKfGZ8487) per conoscervi meglio. Vi chiedo per favore di compilarlo **entro domenica 10 marzo**. 
